...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-md-12" style="margin-bottom:20px">
                <div class="col-md-4">
                    <div class="form-group row">
                        <label for="input" class="col-sm-3 col-form-label font-weight-bold">Class</label>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="drpClassFR" class="form-control col-md-7 col-xs-12" runat="server" OnSelectedIndexChanged="drpClass_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <asp:GridView ID="gvPublishedResult" runat="server" AutoGenerateColumns="False" OnRowCommand="myGridView_RowCommand" class="table table-striped table-bordered text-center" DataKeyNames="RESULT_ID,SUB_ID">
                <Columns>
                    <asp:BoundField DataField="EXAM_TYPE_TEXT" HeaderText="Exam Type" />
                    <asp:BoundField DataField="CLASS_LEVEL" HeaderText="Class" />
                    <asp:BoundField DataField="SUB_NAME" HeaderText="Subject" />
                    <asp:TemplateField HeaderText="Result Card">
                        <ItemTemplate>
                            <asp:HyperLink ID="hlStdInfo" runat="server" Text=''>
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Resources/AppIcon.png" Width="25px" Height="25px" CommandArgument='<%# Eval("RESULT_ID") %>' />
                            </asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
